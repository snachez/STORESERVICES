...
using STORESERVICES.API.SHOPPINGCART.SERVICES.Common;
...
namespace STORESERVICES.API.SHOPPINGCART.Installers
{
    public class SwaggerInstaller : IInstaller
    {
        public void InstallServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var xmlFile = "STORESERVICES.API.SHOPPINGCART.xml";
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "STORESERVICES.API.SHOPPINGCART API",
                    Description = "API de servicios de carrito de compras",
