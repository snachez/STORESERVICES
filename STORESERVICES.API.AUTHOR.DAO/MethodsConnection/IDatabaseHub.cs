...
namespace STORESERVICES.API.AUTHOR.DAO.MethodsConnection
{
    public interface IDatabaseHub
    {
        ...
        Task<List<T>> QueryAsync<T>(string storedProcedureName, IContextoAutor contextoAutor);
        ...
        /// <returns>Retorna cuantas filas hay en la consulta.</returns>         
        Task<T> QueryParameterAsync<T>(string storedProcedureName, IContextoAutor contextoAutor);
        ...
        Task<long> ExecuteAsync<TModel>(string storedProcedureName, TModel model, IContextoAutor contextoAutor);
        ...
        /// <returns></returns>
        Task<long> ExecuteAsync(string storedProcedureName, DynamicParameters parameters, IContextoAutor contextoAutor);
    }
}
