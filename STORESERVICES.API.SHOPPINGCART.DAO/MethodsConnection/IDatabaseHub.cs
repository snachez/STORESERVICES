...
namespace STORESERVICES.API.SHOPPINGCART.DAO.MethodsConnection
{
    public interface IDatabaseHub
    {
        ...
        Task<List<T>> QueryAsync<T>(string storedProcedureName, DynamicParameters parameters, ICarritoContexto carritoContexto);
        ...
        /// <returns>Retorna cuantas filas hay en la consulta.</returns>         
        Task<T> QueryParameterAsync<T>(string storedProcedureName, DynamicParameters parameters, ICarritoContexto carritoContexto);
        ...
        Task<long> ExecuteAsync<TModel>(string storedProcedureName, TModel model, ICarritoContexto carritoContexto);
        ...
        /// <returns></returns>
        Task<long> ExecuteAsync(string storedProcedureName, DynamicParameters parameters, ICarritoContexto carritoContexto);
    }
}
